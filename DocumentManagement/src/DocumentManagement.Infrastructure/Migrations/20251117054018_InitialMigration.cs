        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SharedWithEmail = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    PermissionLevel = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    SharedByEmail = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documents_Title_UploadedBy",
                table: "Documents",
                columns: new[] { "Title", "UploadedBy" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentShares_DocumentId_SharedWithEmail",
                table: "DocumentShares",
                columns: new[] { "DocumentId", "SharedWithEmail" });

            migrationBuilder.CreateIndex(
                name: "IX_DocumentShares_DocumentId_SharedWithEmail_RevokedAt",
                table: "DocumentShares",
                columns: new[] { "DocumentId", "SharedWithEmail", "RevokedAt" },
                unique: true,
                filter: "[RevokedAt] IS NULL");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentShares_RevokedAt",
                table: "DocumentShares",
                column: "RevokedAt");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentShares_SharedWithEmail",
                table: "DocumentShares",
